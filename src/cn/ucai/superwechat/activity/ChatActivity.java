...
//                        responseDownloadMembersListener(toChatUsername),errorListener()));
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
        }
...
//    private Response.Listener<Member[]> responseDownloadMembersListener(final String hxid) {
...
//    }
    ...
    public void toGroupDetails(View view) {
        ...
        if (chatType == CHATTYPE_GROUP) {
            Log.e(TAG, "gourpID="+toChatUsername);
